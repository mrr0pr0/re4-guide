      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {bosses.length > 0 ? (
          bosses.map((boss) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                {boss.chapter && (
                  <p className="text-sm text-gray-500 mb-2">Chapter {boss.chapter}</p>
                )}
                {boss.description && (
                  <p className="text-gray-600 text-sm line-clamp-3">{boss.description}</p>
                )}
              </div>
            </Link>
          ))
          ...
          <div className="col-span-full p-6 bg-white rounded-lg shadow">
            <p className="text-gray-600">No bosses available yet. Check back soon!</p>
          </div>
        )}
      </div>
    </div>
