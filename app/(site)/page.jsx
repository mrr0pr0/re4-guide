	...
	const sections = [
		{
			...
			image:
				'https://res.cloudinary.com/dxeuo6xas/image/upload/v1763714528/walkthore_utvlcg.webp',
		...
		},
		{
			...
			image:
				'https://res.cloudinary.com/dxeuo6xas/image/upload/v1763714632/bossescober_gnhimx.jpg',
		...
		},
		{
			...
			image:
				'https://res.cloudinary.com/dxeuo6xas/image/upload/v1763714731/sg-09r_wqqr8z.png',
		...
		},
		{
			...
			image:
				'https://res.cloudinary.com/dxeuo6xas/image/upload/v1763714795/tresusers_pa4zxa.avif',
		...
		},
		{
			...
			image:
				'https://res.cloudinary.com/dxeuo6xas/image/upload/v1763714858/merthant_zcmjf1.jpg',
		...
		},
		{
			...
			image:
				'https://res.cloudinary.com/dxeuo6xas/image/upload/v1763714944/puzle_nohxev.avif',
				...
				<div className="flex items-start gap-3 mb-4">
					...
					<div className="space-y-4">
						<p className="text-lg lg:text-xl leading-relaxed text-foreground/90">
							...
							<strong className="text-primary">Resident Evil 4 Remake</strong>{' '}
							guide. This resource covers everything you need to survive the
							horror, including a complete{' '}
							<Link
								href="/walkthrough"
						...
						<p className="text-base text-muted-foreground">
							Whether you&apos;re a first-time player or a veteran seeking 100%
							completion, this guide has you covered.
						</p>
					</div>
				</div>
			</div>
